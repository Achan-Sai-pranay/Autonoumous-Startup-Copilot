...
export function buildMarkdown(blueprint, idea) {
  ...
  push();
  push(`_Generated by IdeaPulse AI (https://idea-pulse-startup-validator.vercel.app) on ${formattedDate()}_`);
  push();
...
export async function downloadPdf(blueprint, idea) {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.setFontSize(8);
    doc.setTextColor(148, 163, 184);
    doc.text("IdeaPulse AI • https://idea-pulse-startup-validator.vercel.app", margin, pageHeight - footerZone + 22);
